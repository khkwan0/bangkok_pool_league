...
- `src/app/(tabs)/(index)/cups/manage/[tournamentId].tsx` — 1 bug fix, last fix 7 days ago; 11 commits/90d
...
### Code health
Three co-equal signals: code health 7.74/10 avg (Good), hotspot health 6.96/10 (stable), worst `src/hooks/useAccount.js` at 3.5/10 · maintainability 6.41/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
