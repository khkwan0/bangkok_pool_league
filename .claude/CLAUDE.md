...
- `src/components/CoinFlip/CoinFlipScene.tsx` — 1 bug fix, last fix yesterday; 3 commits/90d
- `src/app/(tabs)/(index)/cups/manage/[tournamentId].tsx` — 1 bug fix, last fix 9 days ago; 11 commits/90d
...
### Code health
Three co-equal signals: code health 7.76/10 avg (Good), hotspot health 7.08/10 (stable), worst `src/hooks/useAccount.js` at 3.5/10 · maintainability 6.45/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
