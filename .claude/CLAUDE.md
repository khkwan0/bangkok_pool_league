...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-22 (commit 8437e4c)Scope: fast index · none content · essential Git · 340 eligible file pages omitted. Missing or unavailable evidence is not a negative finding. Run `repowise update --full` to continue the model-backed upgrade (cost is previewed before generation).Machine-readable scope: `{"analysis": {"skipped": ["generation"], "unavailable": []}, "content_provenance": "none", "file_pages": {"configured_cap": null, "effective_cap": null, "eligible": 340, "generated": 0, "omitted": 340}, "git_commit_cap": 500, "git_history_coverage": {"complete_through_depth": 123, "deep_commits": 0, "deep_files": 0, "eligible_files": 347, "fallback_files": 0, "files_with_history": 347, "global_commits": 123, "per_file_limit": 500, "recent_files": 347, "retained_commits": 856, "unavailable_files": 0, "workers": 8}, "git_tier": "essential", "provider": {"embedder": null, "model": null, "model_cost_possible": false, "name": null, "reused": false}, "run_mode": "fast", "search": {"full_text": "unavailable", "next_command": null, "semantic": "unavailable"}, "upgrade": {"completed_stages": [], "next_stage": "git_backfill", "retryable": true, "status": "pending"}, "version": 1}`
...
- `src/app/(tabs)/(index)/cups/manage/[tournamentId].tsx` — 1 bug fix, last fix 5 days ago; 11 commits/90d
...
- `scripts/archive_ios.sh` — 1 bug fix, last fix 3 weeks ago; 4 commits/90d

### Code health
Three co-equal signals: code health 7.73/10 avg (Good), hotspot health 6.92/10 (stable), worst `src/context/LeagueContext.tsx` at 3.65/10 · maintainability 6.42/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `src/hooks/useLeague.js` — untested hotspot — impact −2.0
- `src/context/LeagueContext.tsx` — untested hotspot — impact −2.0
