...
### Code health
Three co-equal signals: code health 7.75/10 avg (Good), hotspot health 6.98/10 (stable), worst `src/hooks/useAccount.js` at 3.5/10 · maintainability 6.44/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
